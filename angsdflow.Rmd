...
We can also estimate Theta, Pi and Tajima's D on a bp bases, although the file size will be huge. I ran the following command to get this done, hasing out commands that follow on from previous runs (i.e. the first three calls in the file had already been done):
...
#thetaStat make_bed teoFolded.sfs.thetas.gz
thetaStat do_stat teoFolded.sfs.thetas.gz -nChr 15 -outnames teoFolded.thetasPerBp 
